...
using CustomLoginDemo.Blazor.Server.Services;

namespace CustomLoginDemo.Blazor.Server {
    public partial class CustomLoginDemoBlazorApplication : BlazorApplication {
        public CustomLoginDemoBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void CustomLoginDemoBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
